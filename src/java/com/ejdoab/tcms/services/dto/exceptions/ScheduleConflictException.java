...
public class ScheduleConflictException extends Exception {
     ...
     */
    public ScheduleConflictException(String message, Exception exception) {
        super(message);
        wex = exception;
    }
     ...
     */
    public ScheduleConflictException(Exception exception) {
        this(null, exception);
    }
    ...
    public Exception getRootCause() {
        if (wex instanceof ScheduleConflictException) {
            return ((ScheduleConflictException) wex).getRootCause();
        }
    ...
    public String toString() {
        if (wex instanceof ScheduleConflictException) {
            return ((ScheduleConflictException) wex).toString();
        }
