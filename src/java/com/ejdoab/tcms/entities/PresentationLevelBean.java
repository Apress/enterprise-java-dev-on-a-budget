...
/**
 * A TCMS domain entity for table: PRESENTATIONLEVELS
 ...
 *    local-jndi-name="ejb.PresentationLevelLocalHome"
 *    view-type="local"
 *    primkey-field="id"
 *
 * @ejb.finder
 ...
 *    query="SELECT OBJECT(o) FROM PresentationLevel o"
 *
 * @ejb.finder
 *    signature="java.util.Collection findByName(java.lang.String name)"
 *    result-type-mapping="Local"
 *    method-intf="LocalHome"
 *    query="SELECT DISTINCT OBJECT(o) FROM PresentationLevel o WHERE o.name = ?1"
 ...
 *    result-type-mapping="Local"
 *    method-intf="LocalHome"
 *    query="SELECT DISTINCT OBJECT(o) FROM PresentationLevel o WHERE o.description = ?1"
 *    description="DESCRIPTION is not indexed."
 *
 * @ejb.persistence table-name="PRESENTATIONLEVELS"
 *
 * @weblogic.data-source-name $plugin.middlegen.middlegenTask.datasourceJNDIName
 */
public abstract class PresentationLevelBean implements javax.ejb.EntityBean {
   ...
   public java.lang.Integer ejbCreate( java.lang.String name ) throws javax.ejb.CreateException {
      ...
      try {
         ...
         setId(new java.lang.Integer(sequenceGenerator.getNextSequenceNumber( "PRESENTATIONLEVELS.PK_ID" )));
   ...
   // No C:\tcms\src\middlegen\merge/cmp20-presentationlevels-class-code.txt found.
