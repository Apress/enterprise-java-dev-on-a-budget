...
/**
 * A TCMS domain entity for table: PRESENTATIONTOPICS
 ...
 *    local-jndi-name="ejb.PresentationTopicLocalHome"
 *    view-type="local"
 *    primkey-field="id"
 *
 * @ejb.finder
 ...
 *    query="SELECT OBJECT(o) FROM PresentationTopic o"
 *
 * @ejb.finder
 *    signature="java.util.Collection findByName(java.lang.String name)"
 *    result-type-mapping="Local"
 *    method-intf="LocalHome"
 *    query="SELECT DISTINCT OBJECT(o) FROM PresentationTopic o WHERE o.name = ?1"
 ...
 *    result-type-mapping="Local"
 *    method-intf="LocalHome"
 *    query="SELECT DISTINCT OBJECT(o) FROM PresentationTopic o WHERE o.description = ?1"
 *    description="DESCRIPTION is not indexed."
 *
 * @ejb.persistence table-name="PRESENTATIONTOPICS"
 *
 * @weblogic.data-source-name $plugin.middlegen.middlegenTask.datasourceJNDIName
 */
public abstract class PresentationTopicBean implements javax.ejb.EntityBean {
   ...
   public java.lang.Integer ejbCreate( java.lang.String name ) throws javax.ejb.CreateException {
      ...
      try {
         ...
         setId(new java.lang.Integer(sequenceGenerator.getNextSequenceNumber( "PRESENTATIONTOPICS.PK_ID" )));
   ...
   // No C:\tcms\src\middlegen\merge/cmp20-presentationtopics-class-code.txt found.
